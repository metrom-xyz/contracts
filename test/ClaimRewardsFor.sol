...
contract ClaimRewardsForTest is BaseTest {
    function test_failUnauthorizedOperator() public {
        ClaimRewardForBundle[] memory _bundles = new ClaimRewardForBundle[](0);
        vm.expectRevert(IMetrom.DisallowedOperator.selector);
        metrom.claimRewardsFor(_bundles);
    }
    ...
    function test_failZeroAddressRewardToken() public {
        ...
        ClaimRewardForBundle memory _bundle = ClaimRewardForBundle({
            account: address(1020),
        ...
        ClaimRewardForBundle[] memory _bundles = new ClaimRewardForBundle[](1);
        _bundles[0] = _bundle;
